...
\title{Programação 2: Aulas sobre estruturas de controle de decisão}
...
Utilizamos as estruturas de decisão (If/Else) quando existem instruções dentro do programa
 que só devem ser executadas se elas satisfizerem uma determinada condição.
 
Por exemplo: só irei para praia se não chover. 
             Só passarei nesta disciplina se obtiver media superior ou igual a 7,0 e se a presença for igual ao superior a 70% das aulas.
...
O algoritmo \textit{Tal-e-qual} trabalha
Comando IF = se
