...
%  Os resultados mostrados na tabela \ref{tab:resultados} demonstram ...
   ...
   Concluimos, que para fins educacionais,  %o algoritmo \textit{BubbleSort} é mais indicado devido a sua simples implementação, cabendo então para o \textit{QuickSort} ser o mais indicado entre os dois, quando requer uma demanda em menor tempo e com mais eficiência. \newline
