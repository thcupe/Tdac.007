...
\author{Ruben Carlo Benante \\ Guilherme Rodrigues Chaves Do Nascimento \\ Thiago De Azevedo Cavendish \\ Autor3 \\ Ulisses Mosart Sobrinho \\ Joao Alves Pereira Neto \\ Autor6 }
...
\section{Objetivos}
 ...
 \subsection{Objetivo Geral}
   ...
   O projeto tem como objetivo, lecionar sobre as estruturas condicionais da limagem C, tal como sua utilização pratica em um código. 
...
\section{Metodologia}
   ...
   O projeto será composto de duas vídeo aulas sobre as estruturas condicionais da linguagem de programação C. \texttt{C}
...
% Listar os equipamentos necessários para a implementação do projeto.
   ...
   Para realizar este projeto é preciso ter um computador ou um meio de acesso a uma IDE, como por exemple a (coding C) para Android, também é necessário tem acesso à internet para assistir as vídeo aulas disponibilizadas.
